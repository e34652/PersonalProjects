...
<!-- 전역 동작 제어 -->
<script type="text/javascript"
	src="https://store.akamai.steamstatic.com/public/shared/javascript/shared_global.js?v=dsQKg9OwNmqV&amp;l=koreana"></script>

<!-- 메인 페이지 동작 제어 -->
<script type="text/javascript"
	src="https://store.akamai.steamstatic.com/public/javascript/main.js?v=35z9fzDlEKYb&amp;l=koreana"></script>

<!-- 동적 동작 처리 -->
<script type="text/javascript"
	src="https://store.akamai.steamstatic.com/public/javascript/dynamicstore.js?v=lb8HCMTvEMY9&amp;l=koreana"></script>
...
<!-- 홈페이지 동적 요소  -->
<script type="text/javascript"
	src="https://store.akamai.steamstatic.com/public/javascript/home.js?v=SRkPLEvGhCZQ&amp;l=koreana"></script>

<!-- 클러스터 설정 (그룹화, 순환적 표시)-->
<script type="text/javascript"
	src="https://store.akamai.steamstatic.com/public/javascript/cluster.js?v=dDJtCVstwuYC&amp;l=koreana"></script>

<!-- 반응형으로 페이지 디자인 조정   -->
<script type="text/javascript"
	src="https://store.akamai.steamstatic.com/public/shared/javascript/shared_responsive_adapter.js?v=6ERCH2Nxo0Lr&amp;l=koreana"></script>
...
<body class="v6 infinite_scrolling responsive_page">
	...
	<div class="responsive_page_content">
			...
			<div class="content">
				...
				<div role="navigation" class="supernav_container" aria-label="공통 메뉴">
					<a class="menuitem supernav supernav_active"
						...
						상점 </a>
					<div class="submenu_store" style="display: none"
						data-submenuid="store">
						<a class="submenuitem"
							href="/">상점
							홈</a> <a class="submenuitem"
							href="/wishList">찜
							목록</a> <a class="submenuitem"
							href="/news">뉴스</a>

					</div>

					<a class="menuitem supernav" style="display: block"
						href="/community" data-tooltip-type="selector"
						data-tooltip-content=".submenu_community">
						커뮤니티 </a>
					<div class="submenu_community" style="display: none"
						data-submenuid="community">
						<a class="submenuitem" href="/notice">공지사항</a>
						<a class="submenuitem"
							href="/board">자유
							게시판</a>
					...
					<a class="menuitem supernav" style="display: block" href="/mypage"
						data-tooltip-type="selector"
						data-tooltip-content=".submenu_mypage"> 마이페이지
					</a>
					<div class="submenu_mypage" style="display: none"
						data-submenuid="mypage">
						<a class="submenuitem"
							href="/myGames">내 게임</a> <a
							class="submenuitem" href="/myOrders">주문 조회</a>
						<a class="submenuitem" href="/myInfo">내 정보</a> 
					</div>
				</div>
				...
				<div id="global_actions">
					<div role="navigation" id="global_action_menu" aria-label="계정 메뉴">
						 <a class="global_action_link" href="/memberLoginForm">로그인</a>
						&nbsp;|&nbsp; <span class="pulldown global_action_link"
							id="language_pulldown"
							onclick="ShowMenu( this, 'language_dropdown', 'right' );">언어</span>
						<div class="popup_block_new" id="language_dropdown"
							style="display: none">
							<div class="popup_body popup_menu">
								<a class="popup_menu_item tight" href="?l=schinese"
									onclick="ChangeLanguage( 'schinese' ); return false;">한국어</a>
		...
		<div role="main" class="responsive_page_template_content"
			id="responsive_page_template_content" data-panel='{"autoFocus":true}'>

			<div class="home_page_col_wrapper"
				data-panel='{"flow-children":"row"}'>
				<div class="home_page_content home_gutter_outside">
					<div class="home_page_gutter"
						data-panel='{"maintainY":true,"flow-children":"column"}' style="">
						<div class="home_page_gutter_block">

							<div class="gutter_header gutter_top">
								<br /> 뭐넛지
							</div>
							<div class="promo_text">뭐넣쥐</div>
							</a>
							...
							<div class="promo_text">머넛쥐</div>
							</a>

							<div class="home_page_gutter_block"
								id="home_gutter_recentlyviewed" style="display: none">
								<div class="gutter_header pad">머넛지</div>
								<div class="gutter_items"></div>
							</div>

							<div class="gutter_header">뭐넣지</div>
							<div class="gutter_items"></div>

							<div class="gutter_header pad">머넣지</div>
							<div class="gutter_items"></div>
						</div>

						<div class="home_page_gutter_block">
							<div class="gutter_header pad">뭐넝지</div>
				...
				<div class="home_page_body_ctn"
					...
					<div class="static_takeover_ctn"></div>

					<div class="home_page_content">
						<div id="store_header" role="navigation" aria-label="상점 메뉴"
							class="">
							<div class="content">
								<div id="store_controls">
									<div class="cart_status_flex" id="cart_status_data">
										<div data-featuretarget="shoppingcart-count-widget"
											data-props='{"count":0}'></div>
									</div>
								</div>
										...
										<div class="store_nav" data-panel='{"flow-children":"row"}'>
											<div class="tab flyout_tab" id="foryou_tab"
												...
												<span class="pulldown"> <a class="pulldown_desktop"
													href="https://store.steampowered.com/?snr=1_4_4__12">상점
														홈</a>
											</div>
											...
											<div class="tab flyout_tab" id="noteworthy_tab"
												...
												data-flyout-valign="bottom" data-flyout-delay="300"
												data-panel='{"focusable":true}'>
												<span class="pulldown"> <a href="javascript:void(0);"
													class="pulldown_desktop">할인</a>
												</span>
											</div>
											...
											<div class="tab flyout_tab" id="genre_tab"
												...
												data-flyout-align-to-element="foryou_tab"
												data-flyout-delay="300" data-panel='{"focusable":true}'>
												<span class="pulldown"> <a class="pulldown_desktop"
													href="javascript:void(0);">카테고리</a>
												...
												<div class="popup_body popup_menu_twocol_new">
													...
													<div class="popup_menu popup_menu_browse leftborder"
														...
														<div class="popup_menu_subheader reduced_vspace">
															장르</div>
														<div
															class="popup_menu_item popup_genre_expand_header nonresponsive_hidden"
														...
														<div
															...
															<a class="popup_menu_item"
																href="https://store.steampowered.com/category/action/?snr=1_4_4__12">
																액션 </a>
														</div>
														<div class="popup_genre_expand_content responsive_hidden"
															data-genre-group="action">
															<a class="popup_menu_item"
																href="https://store.steampowered.com/category/arcade_rhythm/?snr=1_4_4__12">아케이드
																및 리듬</a> <a class="popup_menu_item"
																href="https://store.steampowered.com/category/action_run_jump/?snr=1_4_4__12">플랫폼
																게임 및 러너</a>
														</div>
														<div
															class="popup_menu_item popup_genre_expand_header nonresponsive_hidden"
														...
														<div
															...
															data-genre-group="adventure">
															<a class="popup_menu_item"
																href="https://store.steampowered.com/category/adventure/?snr=1_4_4__12">
																어드벤처 </a>
														</div>
														<div class="popup_genre_expand_content responsive_hidden"
															data-genre-group="adventure">
															<a class="popup_menu_item"
																href="https://store.steampowered.com/category/metroidvania/?snr=1_4_4__12">메트로배니아</a>
													...
													<div class="popup_menu popup_menu_browse"
														...
														<div
															...
															data-genre-group="rpg">
															<a class="popup_menu_item"
																href="https://store.steampowered.com/category/rpg/?snr=1_4_4__12">
																롤플레잉 </a>
														</div>
														<div class="popup_genre_expand_content responsive_hidden"
															data-genre-group="rpg">
															...
															<a class="popup_menu_item"
																href="https://store.steampowered.com/category/rogue_like_rogue_lite/?snr=1_4_4__12">로그라이크</a>
														...
														<div
															...
															data-genre-group="simulation">
															<a class="popup_menu_item"
																href="https://store.steampowered.com/category/simulation/?snr=1_4_4__12">
																시뮬레이션 </a>
														</div>
														<div class="popup_genre_expand_content responsive_hidden"
															data-genre-group="simulation">
															<a class="popup_menu_item"
																href="https://store.steampowered.com/category/sim_building_automation/?snr=1_4_4__12">건설
																및 자동화</a>
													...
													<div class="popup_menu popup_menu_browse"
														...
														<div
															...
															data-genre-group="strategy">
															<a class="popup_menu_item"
																href="https://store.steampowered.com/category/strategy/?snr=1_4_4__12">
																전략 </a>
														</div>
														<div class="popup_genre_expand_content responsive_hidden"
															data-genre-group="strategy">
															...
															<a class="popup_menu_item"
																href="https://store.steampowered.com/category/tower_defense/?snr=1_4_4__12">타워
																디펜스</a>
														...
														<div
															...
															data-genre-group="sports_and_racing">
															<a class="popup_menu_item"
																href="https://store.steampowered.com/category/sports_and_racing/?snr=1_4_4__12">
																스포츠 및 레이싱 </a>
														</div>
														<div class="popup_genre_expand_content responsive_hidden"
															data-genre-group="sports_and_racing">
															...
															<a class="popup_menu_item"
																href="https://store.steampowered.com/category/sports_fishing_hunting/?snr=1_4_4__12">낚시
																및 사냥</a>
											...
											<div class="search_area">
												<div id="store_search">
													<form id="searchform" name="searchform" method="get"
														...
														<div class="searchbox">
															<input id="store_nav_search_term" name="term"
																type="search" class="default" placeholder="검색하기"
																size="22" autocomplete="off" maxlength="64" />
															<a href="#" id="store_search_link"
																onclick="var $Form = $J(this).parents('form'); $Form.submit(); return false;"
																aria-label="Steam 검색"><img
						...
						<script type="text/javascript">
							// 문서가 로드될 때 실행될 함수 정의함, 드롭다운과 네비바, 툴팁 등 UI요소와 관련
							$J(function() {
						...
						<a
							href="https://store.steampowered.com/app/2688850/EZ2ON_REBOOT__R__HARDCORE_TANOC_Music_Pack_Vol1/?snr=1_4_4__145"
							class="tab_item  " data-ds-appid="2688850"
							data-ds-itemkey="App_2688850"
							data-ds-tagids="[19,597,701,1752,1621,7948,4182]">
							<div class="tab_item_cap">
								<img class="tab_item_cap_img"
									src="https://store.cloudflare.steamstatic.com/public/shared/images/trans.gif"
									id="delayedimage_home_tabs_autoload_2"
									alt="EZ2ON REBOOT : R - HARDCORE TANO*C Music Pack Vol.1">
							</div>
							<div class="discount_block tab_item_discount"
								data-price-final="1232000" data-bundlediscount="0"
								data-discount="15">
								<div class="discount_pct">-15%</div>
								<div class="discount_prices">
									<div class="discount_original_price">₩ 14,500</div>
									<div class="discount_final_price">₩ 12,320</div>
								</div>
							</div>
							<div class="tab_item_content">
								<div class="tab_item_name">EZ2ON REBOOT : R - HARDCORE
									TANO*C Music Pack Vol.1</div>
								<div class="tab_item_details">
									<span class="platform_img win"></span>
									<div class="tab_item_top_tags">
										<span class="top_tag">액션</span><span class="top_tag">,
											캐주얼</span><span class="top_tag">, 스포츠</span><span class="top_tag">,
											리듬</span>
									</div>
								</div>
							</div>
							...
							href="https://store.steampowered.com/app/578080/PUBG_BATTLEGROUNDS/?snr=1_4_4__tab-TopGrossing"
							class="tab_item  " data-ds-appid="578080"
							data-ds-itemkey="App_578080"
							data-ds-tagids="[1662,1774,176981,3859,1663,1775,3814]"
							data-ds-descids="[2,5]" data-ds-crtrids="[44295939,33973721]">
							<div class="tab_item_cap">
								<img class="tab_item_cap_img"
									src="https://cdn.cloudflare.steamstatic.com/steam/apps/578080/capsule_184x69.jpg?t=1710727439"
									alt="PUBG: BATTLEGROUNDS">
							</div>
							<div class="discount_block tab_item_discount no_discount"
								data-price-final="0" data-bundlediscount="0" data-discount="0">
								<div class="discount_prices">
							...
							<div class="tab_item_content">
								...
								<div class="tab_item_details">
									<span class="platform_img win"></span>
									<div class="tab_item_top_tags">
										<span class="top_tag">생존</span><span class="top_tag">,
											슈팅</span><span class="top_tag">, 배틀 로얄</span><span class="top_tag">,
											멀티플레이어</span>
									</div>
								</div>
							</div>
							...
							href="https://store.steampowered.com/app/1969920/Tomb_Explorer_VR/?snr=1_4_4__tab-Upcoming"
							class="tab_item  " data-ds-appid="1969920"
							data-ds-itemkey="App_1969920"
							data-ds-tagids="[21978,3968,3834,3987,30358,1664,5716]"
							data-ds-crtrids="[35021480]">
							<div class="tab_item_cap">
								<img class="tab_item_cap_img"
									src="https://store.cloudflare.steamstatic.com/public/shared/images/trans.gif"
									id="delayedimage_home_tabs_0" alt="Tomb Explorer VR">
							</div>
							<div class="discount_block empty tab_item_discount"></div>
							<div class="tab_item_content">
								<div class="tab_item_name">Tomb Explorer VR</div>
								<div class="tab_item_details">
									<span class="platform_img win"></span><span
										class="platform_img group_separator"></span><span
										class="vr_required">VR 전용</span>
									<div class="tab_item_top_tags">
										<span class="top_tag">VR</span><span class="top_tag">,
											물리</span><span class="top_tag">, 탐험</span><span class="top_tag">,
											역사</span>
									</div>
								</div>
							</div>
						...
						<div id="footer" class="small_footer">
							<div class="footer_content">
								...
								<div class="valve_links" data-panel='{"flow-children":"row"}'>
									<a href="http://www.valvesoftware.com/about" target="_blank"
										rel="">Valve 정보</a> &nbsp; | &nbsp;<a
										href="http://www.valvesoftware.com" target="_blank" rel="">채용
										정보</a> &nbsp; | &nbsp;<a
										href="http://www.steampowered.com/steamworks/" target="_blank"
										rel="">Steamworks</a> &nbsp; | &nbsp;<a
										href="https://partner.steamgames.com/steamdirect"
										target="_blank" rel="">Steam 배포</a> &nbsp;
									| &nbsp;<a
										href="https://help.steampowered.com/ko/?snr=1_44_44_">지원</a>
									&nbsp; | &nbsp;<a
										href="https://store.steampowered.com/digitalgiftcards/?snr=1_44_44_"
										target="_blank" rel="">기프트 카드</a> &nbsp; |
									&nbsp;<a
										href="https://steamcommunity.com/linkfilter/?u=http%3A%2F%2Fwww.facebook.com%2FSteam"
										target="_blank" rel=" noopener"><img
										src="https://store.akamai.steamstatic.com/public/images/ico/ico_facebook.png"
										alt="Facebook" /> Steam</a> &nbsp; | &nbsp;<a
										href="http://twitter.com/steam" target="_blank" rel=""><img
										src="https://store.akamai.steamstatic.com/public/images/ico/ico_twitter.png"
										alt="X" /> @steam</a>
								</div>
							</div>
						</div>
